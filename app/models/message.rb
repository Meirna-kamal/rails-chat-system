class Message < ApplicationRecord
  ...
  validates :message_number, presence: true, uniqueness: { scope: [:client_application_id, :chat_id] }
  ...
  def set_message_number
    Message.transaction do
      max_message_number = Message.where(chat_id: chat_id, client_application_id: client_application_id)
                            .lock("FOR UPDATE")
